...
@Entity
@Table(name = "PageMarketing")
public class PageMarketing {
    @Id
    @GeneratedValue
    private long id;
    ...
    public PageMarketing(String name, String title, String text, String video, String wordFile, String exelFile, String pdfFile) {
        this.name = name;
        this.title = title;
        this.text = text;
        this.video = video;
